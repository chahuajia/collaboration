...
| AI 写了大量代码等我确认   | [[A10-review-前置原则]] → [[W8-规格优先的-AI-协作流程]]                                          |
...
- **先给规格再写实现**；review 对象优先级：规格 > 测试 > 类型 > 实现（[[A10-review-前置原则]] / [[W8-规格优先的-AI-协作流程]]）。
...
[[ROOT]] [[A1-output-format]] [[A6-version-authority]] [[A7-distribution-and-community]] [[A8-设计不是可选项，只有好坏之分]] [[A9-跨域借鉴：不局限在代码思维]] [[A10-review-前置原则]] [[A12-知识笔记返回]] [[A13-AI-入口文件规范]] [[A15-AI-交互协议]] [[A16-上下文预算法]] [[W1-blank-page-triage]] [[W4-three-question-retro]] [[W5-update-collaboration]] [[W7-rfc-process]] [[W8-规格优先的-AI-协作流程]] [[W9-Spike-工作流]]
